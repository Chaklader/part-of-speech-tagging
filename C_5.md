...
##### Hidden Markov Model Probability Tables and Sentence Analysis

###### Transition Probability Table

This shows the probability of moving from one state (row) to another (column):
...
- Sentences typically start with a Noun (3/4) or Modal (1/4)
- After a Noun, we're most likely to see the end of sentence (4/9)
- After a Modal, we're most likely to see a Verb (3/4)
- After a Verb, we always see a Noun (probability 1)

###### Emission Probability Table

This shows the probability of each state (column) emitting a particular word (row):
...
- "Mary" has the highest probability among Nouns (4/9)
- "Will" can be either a Noun (1/9) or a Modal (3/4)
- "Spot" can be either a Noun (2/9) or a Verb (1/4)

###### Example Sentences Analysis

Let me analyze each sentence from the first image and calculate its probability:
...
$P(\text{<S>} \rightarrow \text{N}) \times P(\text{Mary}|\text{N}) \times P(\text{N} \rightarrow \text{N}) \times P(\text{Jane}|\text{N}) \times P(\text{N} \rightarrow \text{M}) \times P(\text{can}|\text{M}) \times P(\text{M} \rightarrow \text{V}) \times P(\text{see}|\text{V}) \times P(\text{V} \rightarrow \text{N}) \times P(\text{Will}|\text{N}) \times P(\text{N} \rightarrow \text{<E>})$

$= \frac{3}{4} \times \frac{4}{9} \times \frac{1}{9} \times \frac{2}{9} \times \frac{3}{9} \times \frac{1}{4} \times \frac{3}{4} \times \frac{1}{2} \times 1 \times \frac{1}{9} \times \frac{4}{9}$

$= \frac{3}{4} \times \frac{4}{9} \times \frac{1}{9} \times \frac{2}{9} \times \frac{3}{9} \times \frac{1}{4} \times \frac{3}{4} \times \frac{1}{2} \times \frac{1}{9} \times \frac{4}{9}$

$= \frac{3 \times 4 \times 1 \times 2 \times 3 \times 1 \times 3 \times 1 \times 4}{4 \times 9 \times 9 \times 9 \times 9 \times 4 \times 4 \times 2 \times 9 \times 9}$

$= \frac{864}{2,239,488} \approx 0.0000386$
...
Probability calculation:
$P(\text{<S>} \rightarrow \text{N}) \times P(\text{Spot}|\text{N}) \times P(\text{N} \rightarrow \text{M}) \times P(\text{will}|\text{M}) \times P(\text{M} \rightarrow \text{V}) \times P(\text{see}|\text{V}) \times P(\text{V} \rightarrow \text{N}) \times P(\text{Mary}|\text{N}) \times P(\text{N} \rightarrow \text{<E>})$

$= \frac{3}{4} \times \frac{2}{9} \times \frac{3}{9} \times \frac{3}{4} \times \frac{3}{4} \times \frac{1}{2} \times 1 \times \frac{4}{9} \times \frac{4}{9}$

$= \frac{3 \times 2 \times 3 \times 3 \times 3 \times 1 \times 4 \times 4}{4 \times 9 \times 9 \times 4 \times 4 \times 2 \times 9 \times 9}$

$= \frac{2,592}{248,832} \approx 0.0104$
...
Probability calculation:
$P(\text{<S>} \rightarrow \text{M}) \times P(\text{Will}|\text{M}) \times P(\text{M} \rightarrow \text{N}) \times P(\text{Jane}|\text{N}) \times P(\text{N} \rightarrow \text{V}) \times P(\text{spot}|\text{V}) \times P(\text{V} \rightarrow \text{N}) \times P(\text{Mary}|\text{N}) \times P(\text{N} \rightarrow \text{<E>})$

$= \frac{1}{4} \times \frac{3}{4} \times \frac{1}{4} \times \frac{2}{9} \times \frac{1}{9} \times \frac{1}{4} \times 1 \times \frac{4}{9} \times \frac{4}{9}$

$= \frac{1 \times 3 \times 1 \times 2 \times 1 \times 1 \times 4 \times 4}{4 \times 4 \times 4 \times 9 \times 9 \times 4 \times 9 \times 9}$

$= \frac{96}{497,664} \approx 0.000193$
...
Probability calculation:
$P(\text{<S>} \rightarrow \text{N}) \times P(\text{Mary}|\text{N}) \times P(\text{N} \rightarrow \text{M}) \times P(\text{will}|\text{M}) \times P(\text{M} \rightarrow \text{V}) \times P(\text{pat}|\text{V}) \times P(\text{V} \rightarrow \text{N}) \times P(\text{Spot}|\text{N}) \times P(\text{N} \rightarrow \text{<E>})$

$= \frac{3}{4} \times \frac{4}{9} \times \frac{3}{9} \times \frac{3}{4} \times \frac{3}{4} \times \frac{1}{4} \times 1 \times \frac{2}{9} \times \frac{4}{9}$

$= \frac{3 \times 4 \times 3 \times 3 \times 3 \times 1 \times 2 \times 4}{4 \times 9 \times 9 \times 4 \times 4 \times 4 \times 9 \times 9}$

$= \frac{2,592}{497,664} \approx 0.0052$

###### Observations on Sentence Probabilities

1. "Spot will see Mary" has the highest probability (≈0.0104), suggesting this is the most grammatically "expected"
   sentence according to our model.
2. "Mary will pat Spot" has the second highest probability (≈0.0052).
3. "Will Jane spot Mary?" has a lower probability (≈0.000193), partly because sentences starting with Modals are less
   common (probability 1/4) in our training data.
4. "Mary Jane can see Will" has the lowest probability (≈0.0000386), likely because it contains consecutive nouns ("Mary
   Jane"), which is relatively rare (probability 1/9).

These probabilities reflect how well each sentence matches the patterns captured in our Hidden Markov Model. The model
has learned both the likelihood of different POS tag sequences (transition probabilities) and the likelihood of
different words appearing as particular parts of speech (emission probabilities) from its training data.
...
1. **Initialization**: For each possible POS tag s for the first word:
    - Calculate probability: $δ₁(s) = P(\text{start}→s) × P(w₁|s)$
...
###### Calculating the Probability for "Jane will spot Will"

Let's work through the calculation for finding the probability of the sentence "Jane will spot Will" with its most
likely POS tag sequence. Based on our HMM model, the most likely tagging would be N-M-V-N (Noun-Modal-Verb-Noun).

###### Step 1: Identify the Sequence Components

First, let's identify all the probability components we'll need to multiply:

1. Start to first tag: P(<S> → N)
2. First word emission: P(Jane|N)
3. First tag to second tag: P(N → M)
4. Second word emission: P(will|M)
5. Second tag to third tag: P(M → V)
6. Third word emission: P(spot|V)
7. Third tag to fourth tag: P(V → N)
8. Fourth word emission: P(Will|N)
9. Fourth tag to end: P(N → <E>)
...
graph LR
    ...
    %% Style definitions
    style Start fill:#BCFB89,stroke:#333,stroke-width:2px
    style End fill:#BCFB89,stroke:#333,stroke-width:2px
    style N fill:#9AE4F5,stroke:#333,stroke-width:2px
    style M fill:#FBF266,stroke:#333,stroke-width:2px
    style V fill:#FA756A,stroke:#333,stroke-width:2px
    ...
    %% Link styles
    linkStyle 0,1,2,3,4,5,6,7,8 stroke:#006699,stroke-width:2px
    linkStyle 9,10,11,12,13,14,15,16,17 stroke:#0CDC2A,stroke-width:1.5px,stroke-dasharray:3
```

###### Step 2: Find Individual Probabilities

From our transition and emission probability tables:
...
$$P(\text{Jane will spot Will}, \text{N M V N}) = P(\text{<S>} \rightarrow \text{N}) \times P(\text{Jane}|\text{N}) \times P(\text{N} \rightarrow \text{M}) \times P(\text{will}|\text{M}) \times P(\text{M} \rightarrow \text{V}) \times P(\text{spot}|\text{V}) \times P(\text{V} \rightarrow \text{N}) \times P(\text{Will}|\text{N}) \times P(\text{N} \rightarrow \text{<E>})$$

Let's substitute the values:

$$= \frac{3}{4} \times \frac{2}{9} \times \frac{3}{9} \times \frac{3}{4} \times \frac{3}{4} \times \frac{1}{4} \times 1 \times \frac{1}{9} \times \frac{4}{9}$$

To make this calculation clearer, I'll break it down step by step:

$$= \frac{3}{4} \times \frac{2}{9} \times \frac{3}{9} \times \frac{3}{4} \times \frac{3}{4} \times \frac{1}{4} \times 1 \times \frac{1}{9} \times \frac{4}{9}$$

$$= \frac{3 \times 2 \times 3 \times 3 \times 3 \times 1 \times 1 \times 1 \times 4}{4 \times 9 \times 9 \times 4 \times 4 \times 4 \times 1 \times 9 \times 9}$$

Let's calculate the numerator: $$3 \times 2 \times 3 \times 3 \times 3 \times 1 \times 1 \times 1 \times 4 = 648$$

And the denominator: $$4 \times 9 \times 9 \times 4 \times 4 \times 4 \times 1 \times 9 \times 9 = 497,664$$

Therefore: $$= \frac{648}{497,664} \approx 0.00130$$

###### Step 4: Compare with Other Sentences

To put this in context, let's compare with the probabilities of other sentences we calculated earlier:

1. "Spot will see Mary" ≈ 0.0104
2. "Mary will pat Spot" ≈ 0.0052
3. "Jane will spot Will" ≈ 0.00130
4. "Will Jane spot Mary?" ≈ 0.000193
5. "Mary Jane can see Will" ≈ 0.0000386

The sentence "Jane will spot Will" ranks third in probability among these examples. It follows the common N-M-V-N
pattern that the model favors, but has lower probability than the top two sentences because:

1. It uses "spot" as a verb (with probability 1/4), which is less common than "see" (with probability 1/2)
2. It uses "Will" as a noun (with probability 1/9), which is less common than other nouns like "Mary" (4/9) or "Spot"
   (2/9)

These differences illustrate how the HMM captures both syntactic structure (through transition probabilities) and word
usage patterns (through emission probabilities) to model language.
